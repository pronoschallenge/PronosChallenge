...
<!--<div align="center">[ <a href="javascript:ShowHide('classement_gen');" class="Style1">Consulter / Masquer le classement</a> - <a href="javascript:ShowHide('journee');" class="Style1">Consulter / Masquer la dernière journée</a> ]<br></div>-->
<div align="center">
	[ <a href="javascript:ShowHide('classement');getData('http://<? echo $_SERVER['SERVER_NAME']; ?>/suopronos/consult/miniseul.php?champmini=<? echo $champ; ?>&typemini=General&presentationmini=1&lienmini=non&classmini=1', 'classement');" class="Style1">Consulter / Masquer le classement</a>
	 - 
	<a href="javascript:ShowHide('journee');getData('http://<? echo $_SERVER['SERVER_NAME']; ?>/suopronos/consult/calendrier_journee.php?champ=<? echo $champ; ?>', 'journee');" class="Style1">Consulter / Masquer la dernière journée</a> ]
	<br>
</div>
