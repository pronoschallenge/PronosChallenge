...
{ 
	...
	{ 
		...
		if($rowUsers[3]=='1') 
		{
			...
			$mailBody .= "Attention ".$rowUsers[1]." ! Vous n'avez toujours pas pronostiqué les matchs suivants :<br>";
			...
			if($sendMail && $rowUsers[2]) 
			{
				...
				$message = $mailBody;
				//$message = "Bon comme vous l'aurez surement compris, c'était encore juste un test. Normalement c'est le dernier, donc le prochain que vous recevrez devra etre pris en compte ;)<br>ça ne vous empeche bien sur pas de faire vos pronos maintenant :)";
