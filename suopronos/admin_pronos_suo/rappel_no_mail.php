...
<table class=phpl width="80%">
            <tr>
              <td class=phpl2 align="center" colspan="3">Matchs non pronostiqu&eacute;s</td>
            </tr>
            <tr>
            <td align="left">
...
{ 
  ...
  // on r�cup�re tous les pronostiqueurs
  ...
  { 
    ...
    if($rowUsers[3]=='1') 
    {
      ...
      echo "<br>Matchs non pronostiqu�s de <b>".$rowUsers[1]."</b> : <br>";
      echo "<ul>";
